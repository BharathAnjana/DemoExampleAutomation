...
public class CreateCustomerCreateModifyDeleteProjectDeleteCustomerDemo6 {
	...
	private static void createCustomer()
	{
		try
		{
		    ...
		    Thread.sleep(2000);
		    oBrowser.findElement(By.xpath("//*[@id='customerLightBox_nameField']")).sendKeys("Customer6");
		    Thread.sleep(2000);
	...
	private static void modifyProject()
	{
		try 
		{
		  ...
		  oBrowser.findElement(By.xpath("//*[@id='taskListBlock']/div[4]/div[1]/div[2]/div[2]/div/div[1]")).click();
		    ...
		    Thread.sleep(2000);
		    oBrowser.findElement(By.xpath("//*[@id='taskListBlock']/div[4]/div[1]/div[2]/div[2]/div/div[2]/input")).sendKeys("ICICI Bank");
		    Thread.sleep(2000);
