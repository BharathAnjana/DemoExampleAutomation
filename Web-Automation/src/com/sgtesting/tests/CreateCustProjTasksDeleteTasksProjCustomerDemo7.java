...
public class CreateCustProjTasksDeleteTasksProjCustomerDemo7 {
	...
	private static void createCustomer()
	{
		try
		{
		    ...
		    Thread.sleep(2000);
		    oBrowser.findElement(By.xpath("//*[@id='customerLightBox_nameField']")).sendKeys("Customer7");
		    Thread.sleep(2000);
	...
	private static void createTasks()
	{
		try
		{
			...
			Thread.sleep(2000);
			oBrowser.findElement(By.xpath("//*[@id='createTasksPopup_createTasksTableContainer']/table/tbody/tr[1]/td[1]/input")).sendKeys("WithDraw Process");
			Thread.sleep(2000);
